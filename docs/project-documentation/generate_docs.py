...
def build():
    ...
    story.append(p(s, s["BodyJ"], "<b>Regional Coverage:</b> The system currently covers the area around Region IV-A CALABARZON and does not cater to all places in the Philippines yet. This showcase demonstrates a potentially helpful system for water delivery businesses operating within this region."))
    story.append(table(
        s,
        ["Item", "Current value"],
        [
